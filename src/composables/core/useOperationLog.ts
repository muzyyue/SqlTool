...
export function useOperationLog() {
   ...
   */
  const logInfo = (msg: string, type?: string, context?: Record<string, any>) => {
   ...
   * @param {Record<string, any>} context - 日志上下文
   */
  const logWarning = (msg: string, type?: string, context?: Record<string, any>) => {
    operationLogs.value.unshift({
      id: generateId(),
      message: msg,
      level: 'warning',
   ...
   * @param {Record<string, any>} context - 日志上下文
   */
  const logError = (msg: string, type?: string, context?: Record<string, any>) => {
    operationLogs.value.unshift({
      id: generateId(),
      message: msg,
      level: 'error',
