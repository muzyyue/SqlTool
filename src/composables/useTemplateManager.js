    ...
    rules: [
      {
        fieldName: 'status',
        newValue: '已完成',
        condition: { enabled: true, fieldName: 'status', operator: '=', value: '待处理' },
    ...
    rules: [
      {
        fieldName: 'amount',
        newValue: '0',
        condition: { enabled: true, fieldName: 'amount', operator: '=', value: '' },
        description: '空金额置零',
      },
      {
        fieldName: 'deleted',
        newValue: '1',
        condition: { enabled: true, fieldName: 'status', operator: '=', value: '已删除' },
        description: '标记删除状态',
      },
    ],
    createdAt: '2025-01-01T00:00:00Z',
