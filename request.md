...
14.重复操作性差，在已经生成了一遍sql的基础上，在进行修改（选择行范围、删除映射配置、）会导致原来的配置错误且不可使用，显示自定义绑定的表格无法显示所有添加的自定义字段，只会显示最新的添加的字段且编辑功能不可用（点击编辑会进入添加自定义字段弹窗，但没有数据显示）
15.字段拼接中的勾选 “是否添加 '' ” 的选项消失了 ？ 现在添加函数有 '' 包裹着

16.修改美化风格后，设置效果没有呈现

17.找一找ai生成代码的规范skill，避免代码堆积问题
